...
ALLOWED_HOSTS = ['adamzakieh.pythonanywhere.com', 'localhost', '127.0.0.1']
...
REDIRECT_URL_WHEN_LOGGED_IN = 'welcome'

# CSRF and Session settings for PythonAnywhere
# PythonAnywhere uses HTTPS, so we need secure cookies
CSRF_TRUSTED_ORIGINS = [
    'https://adamzakieh.pythonanywhere.com',
]
# Required for HTTPS on PythonAnywhere
...
# Ensure CSRF works with proxy/load balancer
